...
var PositionHelper = /** @class */ (function () {
    ...
    PositionHelper.prototype.isStaticPositioned = function (nativeEl) {
        return ($(nativeEl).css("position") || "static") === "static";
    };
    /**
    * Provides coordinates for the targetEl in relation to hostEl
    */
    PositionHelper.prototype.positionElements = function (hostEl, targetEl, positionStr, bufferDistance, appendToBody) {
    ...
    PositionHelper.prototype.breakPositionString = function (positionStr) {
