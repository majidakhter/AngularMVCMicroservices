...
import { Component, OnInit, AfterContentInit, Input, ViewChild, ContentChildren, ElementRef, QueryList, ChangeDetectionStrategy } from '@angular/core';
...
@Component({
    selector: 'ac-map',
    templateUrl: './app/customcomponent/map-component/map.component.html',
