...
describe('AppComponent', () => {
  ...
  describe('konami key', () => {
    ...
    describe('when one key is entered incorrectly', () => {
      beforeEach(() => {
        component.keyEvent({ key: 'ArrowUp' } as any);
        component.keyEvent({ key: 'ArrowUp' } as any);
        component.keyEvent({ key: 'ArrowDown' } as any);
        component.keyEvent({ key: 'ArrowDown' } as any);
        component.keyEvent({ key: 'ArrowLeft' } as any);
        component.keyEvent({ key: 'ArrowRight' } as any);
        component.keyEvent({ key: 'ArrowLeft' } as any);
        component.keyEvent({ key: 'ArrowLeft' } as any);
      });
    ...
    describe('when all keys are entered correctly', () => {
      beforeEach(() => {
        ...
        component.keyEvent({ key: 'ArrowLeft' } as any);
        component.keyEvent({ key: 'ArrowRight' } as any);
        component.keyEvent({ key: 'BackSpace' } as any);
      });
