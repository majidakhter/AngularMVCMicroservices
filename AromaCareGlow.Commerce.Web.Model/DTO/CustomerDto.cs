...
namespace AromaCareGlow.Commerce.Web.Model.DTO
{
    public partial class CustomerDto : BaseEntityDto
    {
        ...
        private ICollection<CustomerCustomerRoleMappingDto> _customerCustomerRoleMappings;
        protected ICollection<CustomerAddressMappingDto> _customerAddressMappings;
        private IList<CustomerRoleDto> _customerRoles;
        ...
        /// </summary>
        public virtual IList<CustomerRoleDto> CustomerRoles
        {
        ...
        /// </summary>
        public virtual ICollection<CustomerCustomerRoleMappingDto> CustomerCustomerRoleMappings
        {
            get => _customerCustomerRoleMappings ?? (_customerCustomerRoleMappings = new List<CustomerCustomerRoleMappingDto>());
        ...
        /// </summary>
        public IList<AddressDto> Addresses => CustomerAddressMappings.Select(mapping => mapping.Address).ToList();

        /// <summary>
        /// Gets or sets customer-address mappings
        /// </summary>
        public virtual ICollection<CustomerAddressMappingDto> CustomerAddressMappings
        {
            get => _customerAddressMappings ?? (_customerAddressMappings = new List<CustomerAddressMappingDto>());
        ...
        public void AddCustomerRoleMapping(CustomerCustomerRoleMappingDto role)
        {
        ...
        /// </summary>
        /// <param name="role">Role</param>
        public void RemoveCustomerRoleMapping(CustomerCustomerRoleMappingDto role)
        {
